dataSetVersion = "2026-05-22"; // Change this when creating a new data set version. YYYY-MM-DD format.
...
dataSet[dataSetVersion].characterData = [
  ...
  },
  {
    name: "Abel (XG)",
    imgUrls: ["XG-Abel.png"],
    wiki: "https://www.xenoserieswiki.org/wiki/Abel_(XG)",
    opts: {
      role: ["npc"],
      series: ["XG"],
      spoiler: true
  ...
  {
    name: "Alice",
    imgUrls: ["XG-Alice.png"],
    wiki: "https://www.xenoserieswiki.org/wiki/Abel",
    opts: {
      role: ["npc"],
      series: ["XG"]
    }
  ...
  {
    name: "Bishop Stone",
    imgUrls: ["XG-Bishop Stone.png"],
    wiki: "https://www.xenoserieswiki.org/wiki/Isaac_Stone",
    opts: {
      role: ["minant"],
      series: ["XG"]
    }
  ...
  {
    name: "Captain of the Thames",
    imgUrls: ["XG-Captain.png"],
    wiki: "https://www.xenoserieswiki.org/wiki/Thames_Captain",
    opts: {
      role: ["npc"],
      series: ["XG"]
    }
  ...
  {
    name: "\"The Coward\"",
    imgUrls: ["XG-Coward.png"],
    wiki: "https://www.xenoserieswiki.org/wiki/Fei#Dissociative_Identity_Disorder",
    opts: {
      role: ["npc"],
      series: ["XG"],
      spoiler: true
  ...
  {
    name: "Erich Van Houten",
    imgUrls: ["XG-Erich Van Houten.png"],
    wiki: "https://www.xenoserieswiki.org/wiki/Erich_Van_Houten",
    opts: {
      role: ["npc"],
      series: ["XG"]
    }
  ...
  {
    name: "Medena Van Houten",
    imgUrls: ["XG-Medena Van Houten.png"],
    wiki: "https://www.xenoserieswiki.org/wiki/Medena_Van_Houten",
    opts: {
      role: ["npc"],
      series: ["XG"]
    }
  ...
  {
    name: "Isaac Balthasar",
    imgUrls: ["XG-Isaac.png"],
    wiki: "https://www.xenoserieswiki.org/wiki/Isaac_Balthasar",
    opts: {
      role: ["npc"],
      series: ["XG"]
    }
  ...
  {
    name: "Kaiser Sigmumd",
    imgUrls: ["XG-Kaiser.png"],
    wiki: "https://www.xenoserieswiki.org/wiki/Sigmund",
    opts: {
      role: ["npc"],
      series: ["XG"]
    }
  ...
  {
    name: "Karen",
    imgUrls: ["XG-Karen.png"],
    wiki: "https://www.xenoserieswiki.org/wiki/Karen",
    opts: {
      role: ["minant"],
      series: ["XG"]
    }
  },
  {
    name: "Kim",
    imgUrls: ["XG-Kim.png"],
    wiki: "https://www.xenoserieswiki.org/wiki/Kim",
    opts: {
      role: ["npc"],
      series: ["XG"],
      spoiler: true,
  ...
  {
    name: "Nikolai",
    imgUrls: ["XG-Nikolai.png"],
    wiki: "https://www.xenoserieswiki.org/wiki/Nikolai_Balthasar",
    opts: {
      role: ["npc"],
      series: ["XG"]
    }
  ...
  {
    name: "Primera",
    imgUrls: ["XG-Primera.png"],
    wiki: "https://www.xenoserieswiki.org/wiki/Primera_Black",
    opts: {
      role: ["npc"],
      series: ["XG"]
    }
  ...
  {
    name: "Sophia",
    imgUrls: ["XG-Sophia.png"],
    wiki: "https://www.xenoserieswiki.org/wiki/Sophia",
    opts: {
      role: ["npc"],
      series: ["XG"],
      duplicate: true,
  ...
  {
    name: "Timothy",
    imgUrls: ["XG-Timothy.png"],
    wiki: "https://www.xenoserieswiki.org/wiki/Timothy",
    opts: {
      role: ["npc"],
      series: ["XG"]
    }
  ...
  {
    name: "Vanderkaum",
    imgUrls: ["XG-Vanderkaum.png"],
    wiki: "https://www.xenoserieswiki.org/wiki/Vanderkaum",
    opts: {
      role: ["minant"],
      series: ["XG"]
    }
  ...
  {
    name: "Aizen Magus",
    imgUrls: ["XS-Aizen.png"],
    wiki: "https://www.xenoserieswiki.org/wiki/Aizen_Magus",
    opts: {
      role: ["npc"],
      series: ["XS"]
    }
  },
  {
    name: "Aoi Uzuki",
    imgUrls: ["XS-Aoi.png"],
    wiki: "https://www.xenoserieswiki.org/wiki/Aoi_Uzuki",
    opts: {
      role: ["npc"],
      series: ["XS"]
    }
  },
  {
    name: "Suou Uzuki",
    imgUrls: ["XS-Suou.png"],
    wiki: "https://www.xenoserieswiki.org/wiki/Suou_Uzuki",
    opts: {
      role: ["npc"],
      series: ["XS"]
    }
  ...
  {
    name: "Hermann",
    imgUrls: ["XS-Hermann.png"],
    wiki: "https://www.xenoserieswiki.org/wiki/Hermann",
    opts: {
      role: ["minant"],
      series: ["XS"]
    }
  ...
  {
    name: "Richard",
    imgUrls: ["XS-Richard.png"],
    wiki: "https://www.xenoserieswiki.org/wiki/Richard",
    opts: {
      role: ["minant"],
      series: ["XS"]
    }
  ...
  {
    name: "Lapis Roman",
    imgUrls: ["XS-Lapis.png"],
    wiki: "https://www.xenoserieswiki.org/wiki/Lapis",
    opts: {
      role: ["npc"],
      series: ["XS"]
    }
  },
  {
    name: "Mai Magus",
    imgUrls: ["XS-Mai.png"],
    wiki: "https://www.xenoserieswiki.org/wiki/Mai_Magus",
    opts: {
      role: ["npc"],
      series: ["XS"]
    }
  ...
  {
    name: "Mary Magdalene",
    imgUrls: ["XS-Mary Magdalene.png"],
    wiki: "https://www.xenoserieswiki.org/wiki/Mary_Magdalene",
    opts: {
      role: ["npc"],
      series: ["XS"],
      spoiler: true
  ...
  },
  {
    ...
    imgUrls: ["XS-Mizrahi.png"],
    wiki: "https://www.xenoserieswiki.org/wiki/Joachim_Mizrahi",
    opts: {
      role: ["npc", "minant"],
      series: ["XS"]
    }
  ...
  {
    name: "Orgulla",
    imgUrls: ["XS-Orgulla.png"],
    wiki: "https://www.xenoserieswiki.org/wiki/Orgulla",
    opts: {
      role: ["minant"],
      series: ["XS"]
    }
  ...
  {
    name: "Sakura",
    imgUrls: ["XS-Sakura.png"],
    wiki: "https://www.xenoserieswiki.org/wiki/Sakura_Mizrahi",
    opts: {
      role: ["npc"],
      series: ["XS"]
    }
  ...
  {
    name: "Sellers",
    imgUrls: ["XS-Sellers.png"],
    wiki: "https://www.xenoserieswiki.org/wiki/Sellers",
    opts: {
      role: ["majant"],
      series: ["XS"]
    }
  ...
  {
    name: "Togashi",
    imgUrls: ["XS-Togashi.png"],
    wiki: "https://www.xenoserieswiki.org/wiki/Togashi_Yukihira",
    opts: {
      role: ["npc"],
      series: ["XS"]
    }
  ...
  },
  {
    name: "Oka",
    imgUrls: ["XC-Oka.png"],
    wiki: "https://www.xenoserieswiki.org/wiki/Oka",
    opts: {
      role: ["npc"],
      series: ["XC"]
    }
  ...
  {
    name: "Dunga",
    imgUrls: ["XC-Dunga.png"],
    wiki: "https://www.xenoserieswiki.org/wiki/Dunga",
    opts: {
      role: ["npc"],
      series: ["XC"]
    }
  ...
  {
    name: "Arglas",
    imgUrls: ["XC-Arglas.png"],
    wiki: "https://www.xenoserieswiki.org/wiki/Arglas",
    opts: {
      role: ["npc"],
      series: ["XC"]
    }
